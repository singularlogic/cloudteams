...
$(document).ready(function () {
    ...
    $(document).ajaxStart(function () {
        $("#ct-content-github").html(getLoadingHTML());
        $("#ct-content-sonarqube").html(getLoadingHTML());
        $("#ct-content-bitbucket").html(getLoadingHTML());
        $("#ct-content-jira").html(getLoadingHTML());
        $("#ct-content-paasport").html(getLoadingHTML());
        $("#widget-loading").show();
    });
    //Load Github widget
    loadGithubWidget();
